// Modal: carga los datos del postulante
  const modalPostulante = document.getElementById('modalPostulante');
    modalPostulante?.addEventListener('show.bs.modal', function (event) {
        ...
        document.getElementById('modalNombre').value = trigger.getAttribute('data-nombre') || '';
        document.getElementById('modalCI').value = trigger.getAttribute('data-ci') || '';
        document.getElementById('modalFechaNacimiento').value = trigger.getAttribute('data-fechanacimiento') || '';
        document.getElementById('modalCelular').value = trigger.getAttribute('data-celular') || '';
        document.getElementById('modalNroContrato').value = trigger.getAttribute('data-nrocontrato') || '';
        document.getElementById('modalNroGrupo').value = trigger.getAttribute('data-nrogrupo') || '';
        document.getElementById('modalPDSE').value = trigger.getAttribute('data-pdse') || '';
    });

  // Guardar PDSE
    document.getElementById('btnGuardarPDSE')?.addEventListener('click', function() {
